...
export default function Home() {
  // State variables to store the city, weather data, and loading status
  const [city, setCity] = useState('');
  const [weather, setWeather] = useState({});
  const [loading, setLoading] = useState(false);

  // API URL for fetching weather data based on the city
  ...
  if (loading) {
    ...
    // Otherwise, render the weather information
    return (
      <div>
        {/* Head element to set the page title and meta description */}
        <Head>
